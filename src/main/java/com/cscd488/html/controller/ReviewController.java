        ...
        try {
            ...
            if (originalText != null && !originalText.trim().isEmpty()) {
                try {
                    ...
                    customerService.saveVehicle(savedVehicle);
            ...
            // Build the text for file storage (optional - you can remove this if not needed)
            String text = formattedDateTime + "\nOrder Number: " + orderNumber + "\n" +
                    "Customer: " + savedCustomer.getFname() + " " + savedCustomer.getLname() + "\n" +
                    "Email: " + savedCustomer.getEmail() + "\n" +
                    "Vehicle: " + savedVehicle.getYear() + " " + savedVehicle.getMake() + " " + savedVehicle.getModel() + "\n" +
                    "VIN: " + savedVehicle.getVin() + "\n" +
                    "Issue Location: " + savedVehicle.getIssueLocation() + "\n" +
                    "Issue Type: " + savedVehicle.getIssueType() + "\n" +
                    "Severity: " + savedVehicle.getSeverity() + "\n" +
                    "Original Comments: " + originalText + "\n" +
                    "Translated Comments: " + translatedText;

            String fileName = savedCustomer.getLname() + "_" + orderNumber + ".txt";
